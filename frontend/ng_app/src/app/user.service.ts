...
export class UserService {
  ...
  public registerUser(data) {
    this.http.post(this.api_base_url+'/api/users/', JSON.stringify(data), this.httpOptions).subscribe(
      data => {
  ...
  // Uses http.post() to get an auth token from djangorestframework-jwt endpoint
  public login(user) {
    this.http.post(this.api_base_url+'/api/token/', JSON.stringify(user), this.httpOptions).subscribe(
      data => {
   ...
   */
  public refreshToken() {
    this.http.post(this.api_base_url+'/api/token/refresh/', JSON.stringify({refresh: this.refresh}), this.httpOptions).subscribe(
      data => {
